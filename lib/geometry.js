...
Geometry.parseTwkb = function (value) {
    ...
    while (binaryReader.position < value.length) {
        ...
        switch (geometryType) {
            case Types.wkb.Point:
                geom = Point._parseTwkb(binaryReader, options);
                break;
            case Types.wkb.LineString:
                geom = LineString._parseTwkb(binaryReader, options);
                break;
            case Types.wkb.Polygon:
                geom = Polygon._parseTwkb(binaryReader, options);
                break;
            case Types.wkb.MultiPoint:
                geom = MultiPoint._parseTwkb(binaryReader, options);
                break;
            case Types.wkb.MultiLineString:
                geom = MultiLineString._parseTwkb(binaryReader, options);
                break;
            case Types.wkb.MultiPolygon:
                geom = MultiPolygon._parseTwkb(binaryReader, options);
                break;
            case Types.wkb.GeometryCollection:
                geom = GeometryCollection._parseTwkb(binaryReader, options);
                break;
            default:
                throw new Error('GeometryType ' + geometryType + ' not supported');
        }
